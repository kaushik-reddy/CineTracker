        ...
        <div className="px-4 py-3 flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {schedule.is_watch_party && (
              <span className="ml-2 px-1.5 py-0.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-[9px] font-bold rounded shadow-lg shadow-purple-900/20 animate-pulse">
                WATCH PARTY
              </span>
            )}
          </div>
