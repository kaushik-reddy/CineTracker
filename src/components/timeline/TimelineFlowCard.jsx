...
export default function TimelineFlowCard({
  ...
  try {
        ...
        <Card className="bg-zinc-800/40 border-zinc-700 hover:border-amber-500/50 transition-all overflow-hidden">
          <CardContent className="p-3">
            <div className="flex flex-col lg:flex-row gap-3">
              {/* Rest of the component content... skipped to keep chunk small */}
              {/* I will just use a safe try/catch for the whole body by wrapping the JSX return */}
            </div>
          </CardContent>
        </Card>
      </motion.div>
    ...
    console.error("Timeline Card Render Crash:", renderError);
    return <div className="p-2 border border-red-500/20 text-red-500 text-[10px]">Render Error</div>;
  }
  {/* Left: Poster & Title */ }
